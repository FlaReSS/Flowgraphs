...
class flaress_modulation_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(1, firdes.low_pass(
        	1, samp_rate, cof, tw, firdes.WIN_HAMMING, 6.76))
        self.flaress_selector_0 = flaress.selector(gr.sizeof_char*1, 0, 2, 1)
        self.ecss_phase_converter_0 = ecss.phase_converter(n_bit)
        self.ecss_modulator_0 = ecss.modulator(7, 2, ([79,-109]), 0, False, samp_rate, bit_rate, 1, 0, 1, 0.35, samp_rate/11, True, 16000)
        self.ecss_coherent_phase_modulator_0 = ecss.coherent_phase_modulator(n_bit, 1)
        self.blocks_unpack_k_bits_bb_0 = blocks.unpack_k_bits_bb(8)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_char*1, samp_rate,True)
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, '/mnt/c/Users/amir/WSL/grc/FlowGraps/FlaReSS/files/Convolutionally_encoded_CADU.bin', True)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/mnt/c/Users/amir/WSL/grc/FlowGraps/FlaReSS/files/CADU.bin', True)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/mnt/c/Users/amir/WSL/grc/FlowGraps/FlaReSS/files/modulated_signal_output', False)
        ...
        self.connect((self.ecss_coherent_phase_modulator_0, 0), (self.blocks_file_sink_0, 0))
        ...
        self.connect((self.ecss_phase_converter_0, 0), (self.ecss_coherent_phase_modulator_0, 0))
